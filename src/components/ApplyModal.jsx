...
const ApplyModal = ({ onClose, onSwitchToLogin }) => {
  ...
  const handleRegister = async (e) => {
    ...
    if (result.success) {
      ...
      // After 2 seconds, redirect to registration flow
      setTimeout(() => {
        onClose();
        navigate("/register");
      }, 2000);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Success Message */}
        {registrationSuccess && (
          <div className="w-full max-w-[450px] mb-4 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg text-center">

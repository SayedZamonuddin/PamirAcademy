...
import { submitExam } from "../../../utils/registrationApi";
...
export default function Exam() {
  ...
  const handleSubmit = async () => {
    ...
    const examData = { subject, level: currentSection, score, total, percentage, answers, timeSpent };
    ...
    try { await submitExam(subject, currentSection, answers, timeSpent); } catch { /* API may be offline */ }

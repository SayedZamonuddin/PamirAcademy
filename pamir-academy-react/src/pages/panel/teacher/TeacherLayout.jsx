...
const TEACHER_AVATAR = "https://images.unsplash.com/photo-1726618069974-c1d5d27f612b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx5b3VuZyUyMGZlbWFsZSUyMHRlYWNoZXIlMjBwb3J0cmFpdCUyMHByb2Zlc3Npb25hbHxlbnwxfHx8fDE3NzQwMDg2NDd8MA&ixlib=rb-4.1.0&q=80&w=1080";
      ...
      <header className="flex items-center justify-between px-[clamp(16px,4vw,80px)] py-4 min-h-[80px]">
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            <div className="text-white">Amina Rahimi</div>
            <div className="text-[#7d807f] text-xs">Teacher — English</div>
          </div>
          <div className="w-[50px] h-[50px] rounded-full overflow-hidden border-2 border-[#006236]">
            <img src={TEACHER_AVATAR} alt="Profile" className="w-full h-full object-cover" />
          </div>
          <button onClick={() => navigate("/dashboard")} className="bg-[#006236] text-white px-6 py-2.5 rounded-full border-none cursor-pointer text-sm tracking-wider">ADMIN</button>
